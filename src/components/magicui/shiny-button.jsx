  ...
  return (
    (<motion.button
      ...
      <span
        ...
        className="absolute inset-0 z-10 block rounded-[inherit] bg-[linear-gradient(-75deg,rgb(255,0,0)/10%)_calc(#fff+20%),rgb(0,0,200)/50%)_calc(#fff+25%),rgb(100,255,100)/10%)_calc(#fff+100%))] p-px"></span>
    </motion.button>)
  );
};
